  ...
  return (
    <div className="page" ref={ref}>
      <footer className="footer">
        <div className="footer-grid">
          <div className="footer-logo">
            ...
            <p className="company-description">
              Building excellence for over 25 years with superior quality
              construction and engineering services across Egypt, Oman,
        ...
        <div className="copy">
          © {currentYear} Red Sea Construction. All rights reserved. | Building
          the future, today.
        </div>
      </footer>
    </div>
